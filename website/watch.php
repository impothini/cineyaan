...
<script type='text/javascript' src='http://ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js'></script>
    ...
    <link type='text/css' rel='stylesheet' href='overlaypopup.css' />
		...
		<body>
			...
			$select_query="Select * from movies where id='".$id."';";
    	...
    	<tr>
    		...
    		<td width="60%">
    			...
    			<table border="0px" bordercolor="#0000" style="border-collapse: collapse;" >
    				<tr  bgcolor="#58ACFA"><td>
    					<table >
    				<tr><td><font style="color: white"><?php echo "$name &nbsp ($year)"; ?></font></td></tr>
    				<tr height="315" bgcolor="#000"><td>
    				<div align="center">
    				<?php echo"<iframe width='750' height='415' src='//www.youtube.com/embed/$id?iv_load_policy=3' frameborder='0' yt:stretch=16:9 allowfullscreen></iframe>"; ?>
    			</div></td></tr>
