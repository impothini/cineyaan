...
$rs = mysqli_query($conn, $sql);
  ...
  echo "<td><table><tr><td border='3' width=105px><a style='text-decoration:none; color:black; font-family:Georgia, Garamond, Serif;' href='nwatch.php?id=$id[$i]&title=$name[$i]&ty=news'><img src='http://img.youtube.com/vi/$id[$i]/mqdefault.jpg'style='border-radius:10px;width:100px;height:75px;'></td>";
  echo "<td align='left'><a class='news' style='text-decoration:none; color:#222222; font-family:Georgia, Garamond, Serif;font-weight:normal; font-size:6' href='nwatch.php?id=$id[$i]&title=$name[$i]&ty=news'> <b><h5>$name[$i]</a></h5></b></td></a></tr></table></td>";
  echo "<td width='2px' bgcolor='00A0EB'></td>";
  $i++;
