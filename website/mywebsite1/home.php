...
$rs = mysqli_query($conn, $sql);
  ...
  $year = $row_data['YEAR'];
  $hero = $row_data['Hero'];
  echo "<td border='3'align='center' width='40%'><a style='text-decoration:none;color=black;' href='watch.php?id=$id&mv=$name&yr=$year&hr=$hero'><table bgcolor='FFFFFF' height='192px' ><tr ><td align='center' style='width:130px;height:140px;'><img src='http://img.youtube.com/vi/$id/mqdefault.jpg'style='border-radius:10px;width:95%;height:90%;'></td></tr>";
