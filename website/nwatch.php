    	...
    	<tr>
    		<td width="70%">
    			<table border="2px" bordercolor="#00A0EB" style="border-collapse: collapse;" >
    				...
    				<div align="center">
    				<?php echo"<iframe width='620' height='415' src='//www.youtube.com/embed/$id?iv_load_policy=3' frameborder='0' yt:stretch=16:9 allowfullscreen></iframe>"; ?>
    			</div></td></tr>
    			</table>
    			</td></tr>
<?php 
...
$rs = mysqli_query($conn, $sql);
  ...
  echo "<td width='700'><table><tr><td border='3' width=105px><a style='text-decoration:none; color:black; font-family:Georgia, Garamond, Serif;' href='nwatch.php?ty=$ty&id=$id'><img src='http://img.youtube.com/vi/$id/mqdefault.jpg'style='border-radius:10px;width:100px;height:75px;'></td>";
  echo "<td align='left'><a class='news' style='text-decoration:none; color:#222222; font-family:Georgia, Garamond, Serif;font-weight:normal; font-size:6' href='nwatch.php?ty=$ty&id=$id'> <b><h5>$name</a></h5></b></td></a></tr></table></td>";
  //echo "<td width='2px' bgcolor='00A0EB'></td>
  echo "</tr></table></td></tr>";
